...
<div class="container">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-between">
    <div class="list-group list-group-horizontal-sm flex-fill">
      ...
      <a href="/user/<?=$visiteduser->getIdentifier()?>/sites" class="list-group-item list-group-item-action <?php if ($page == 'sites') echo 'active'?>"">Sites</a>
      <a href="/user/<?=$visiteduser->getIdentifier()?>/teams" class="list-group-item list-group-item-action <?php if ($page == 'teams') echo 'active'?>"">Teams</a>
      <a href="/user/<?=$visiteduser->getIdentifier()?>/followers" class="list-group-item list-group-item-action <?php if ($page == 'followers') echo 'active'?>"">Followers</a>
    </div>
  </nav>
