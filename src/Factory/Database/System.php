...
class System
{
    ...
    public function up()
    {
        $tables = array(
            ...
            "CREATE TABLE IF NOT EXISTS `sites` (id integer not null primary key auto_increment, usersid integer not null references users(id), identifier char(64) not null default '', screenshot varchar(255) not null default '/assets/statusible-100x100.png')",
